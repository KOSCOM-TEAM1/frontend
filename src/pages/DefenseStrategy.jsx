            ...
            {strategies.map((strategy) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-white font-bold text-[15px] mb-0.5">{strategy.title}</p>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-[11px] text-white/40 bg-white/5 px-1.5 py-0.5 rounded">{strategy.subtitle}</span>
                    <div className="flex items-center gap-1">
                      <div className={`w-1.5 h-1.5 ${strategy.dotColor} rounded-full`}></div>
                      <span className={`text-[11px] ${strategy.scoreColor} font-bold`}>점수: {strategy.score}</span>
                    </div>
                  </div>
                </div>
              </div>
