...
export const strategyMockResponse = {
  ...
  holdings: [
    ...
    { id: 3, icon: "movie", name: "NFLX", subName: "넷플릭스 (Netflix)", impact: "매우 낮음", change: "+1.32%", positive: true, type: "해외", recommendation: "유지", recommendationColor: "text-slate-400", dotColor: "bg-slate-500", bgColor: "bg-slate-500/10", borderColor: "border-slate-500/30", shadowColor: "rgba(100, 116, 139, 0.4)", reason: "AI 메모리 사이클과 거의 무관 · 구독·광고·콘텐츠 변수 중심" },
    ...
    { id: 7, icon: "restaurant", name: "삼양식품", subName: "Samyang Foods", impact: "매우 낮음", change: "+1.83%", positive: true, type: "국내", recommendation: "유지", recommendationColor: "text-slate-400", dotColor: "bg-slate-500", bgColor: "bg-slate-500/10", borderColor: "border-slate-500/30", shadowColor: "rgba(100, 116, 139, 0.4)", reason: "반도체/AI 메모리 테마와 무관 · 소비재·수출 변수 중심" },
  ],
  keyBeneficiaries: [
